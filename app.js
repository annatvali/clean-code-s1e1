...
var taskInput=document.querySelector(".task-entry__input");//Add a new task.
var addButton=document.querySelectorAll(".btn")[0];//first button
var incompleteTaskHolder=document.querySelector(".incomplete-task__list");//ul of #incomplete-tasks
...
for (var i=0; i<incompleteTaskHolder.children.length;i++){
  ...
  //bind events to list items chldren(taskCompleted)
